...
function saveScrollPos() {
  ...
  /**
   * Ocultar alertas suavemente después de un tiempo.
   * Se ejecuta desde el código central de base.html y también se encuentra en el código original.
   */
  document.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
      var flashAlerts = document.querySelectorAll(".alert:not(.persistent-alert)");
      flashAlerts.forEach(function(alert) {
        // Se añade la clase 'shrink' para la transición y luego se elimina el elemento
  ...
  /**
   * Configura el modal de edición de trabajos.
   * Rellena el formulario del modal con los datos almacenados en los atributos data-* del botón.
   */
  ...
  /**
   * Configura el modal de edición de técnicos.
   */
  document.body.addEventListener('click', function(event) {
  ...
  /**
   * Listener para botones de toggle de disponibilidad.
   * Se asegura de que el evento no propague y envía el formulario del toggle.
   */
  ...
  /**
   * Listener para botones de eliminación de trabajos.
   * Configura el formulario de eliminación según el ID del trabajo.
   */
  document.body.addEventListener('click', function(event) {
  ...
  /**
   * Listener para botones de completado de trabajos.
   * Configura el formulario para marcar un trabajo como completado.
   */
  document.body.addEventListener('click', function(event) {
  ...
  /**
   * Listener para botones de eliminación de técnicos.
   */
  document.body.addEventListener('click', function(event) {
  ...
  /**
   * Toggle de visibilidad para el input de contraseña (login y registro).
   */
  document.addEventListener('DOMContentLoaded', function() {
  ...
  /**
   * Toggle de visibilidad para el input de confirmación de contraseña.
   */
  document.addEventListener('DOMContentLoaded', function() {
  ...
  /**
   * Validación en el formulario de registro para que las contraseñas coincidan.
   */
  document.addEventListener('DOMContentLoaded', function() {
  ...
  /**
   * Configuración del modal de detalles en la página de Historial.
   * Rellena los campos del modal usando los atributos data-* del botón.
   */
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      const formEditar = document.getElementById("formEditarTrabajo");
      const telefonoInput = document.getElementById("telefono");
    
      if (formEditar && telefonoInput) {
